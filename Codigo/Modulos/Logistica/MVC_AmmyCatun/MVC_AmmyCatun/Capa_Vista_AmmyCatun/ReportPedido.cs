...
namespace Capa_Vista_AmmyCatun {
    ...
    public class ReportPedido : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "Capa_Vista_AmmyCatun.ReportPedido.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedReportPedido : Component, ICachedReport {
        
        public CachedReportPedido() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            ReportPedido rpt = new ReportPedido();
            rpt.Site = this.Site;
            return rpt;
        }
