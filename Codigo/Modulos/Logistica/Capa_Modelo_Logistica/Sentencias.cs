...
namespace Capa_Modelo_Logistica
{
    public class Sentencias
    {
        ...
        public string[] llenarCmbCuentas(string stabla, string scampo1, string scampo2)
        {
            ...
            try
            {
                OdbcCommand command = new OdbcCommand(ssql, con.conexion());
        ...
        public void ActulizarCuentas(int iidCuenta, string stipoOperacion, decimal devalor)
        {
            ...
            try
            {
                ...
                using (OdbcCommand cmdUpdate = new OdbcCommand(supdateQuery, con.conexion()))
                {
        ...
        public void ActualizarHistorico(int iidCuenta, decimal deval, string stipoOperacion)
        {
            ...
            try
            {
                using (OdbcCommand cmdHistorico = new OdbcCommand(sselectHistorico, con.conexion()))
                {
                ...
                if (bexisteHistorico)
                {
                    ...
                    using (OdbcCommand cmdUpdateHistorico = new OdbcCommand(supdateHistorico, con.conexion()))
                    {
                ...
                else
                {
                    ...
                    using (OdbcCommand cmdInsertHistorico = new OdbcCommand(sinsertHistorico, con.conexion()))
                    {
        ...
        public string ModRuta(string sIdAyuda)
        {
            ...
            using (OdbcCommand command = new OdbcCommand(sQuery, con.conexion()))
            {
        ...
        public string ProbarTabla(string sTabla)
        {
            ...
            try
            {
                OdbcCommand command = new OdbcCommand("SELECT * FROM " + sTabla + ";", con.conexion());
                OdbcDataReader reader = command.ExecuteReader();
                reader.Read();
            }
            catch (Exception)
        ...
        public int ContarReg(string sIdIndice)
        {
            ...
            try
            {
                OdbcCommand command = new OdbcCommand("SELECT * FROM ayuda WHERE id_ayuda = " + sIdIndice + ";", con.conexion());
                OdbcDataReader reader = command.ExecuteReader();
