...
namespace Capa_Modelo_Cierre_Produccion
{
    public class Sentencia_Cierre_Produccion
    {
        private Conexion_Cierre_Produccion conexion = new Conexion_Cierre_Produccion();
